...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-600 text-white">
        <main class="w-full h-screen relative">
            <img class="h-full w-full object-cover absolute top-0 left-0 grayscale" src="https://images.unsplash.com/photo-1655161920449-cd10d9391f44?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&q=80">
